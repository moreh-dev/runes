...
2026-04-29 Hyeonki 가 결정한 컨벤션입니다. 동기가 된 사건: Odin 저장소에서
Claude 가 PRD 에 implementation snapshot 을 함께 적었고, 이후 코드와 어긋날
때 mismatch 를 "history event" 로 인식해 "used to do A, now B" 형태로 PRD 에
누적시켰습니다. 결과적으로 PRD 의 evergreen 보장이 침식되었습니다.

추적: [MAF-19914](https://moreh.atlassian.net/browse/MAF-19914).
